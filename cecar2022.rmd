...
- As the global climate warms, we will all encounter weather events that are, or could be, "caused by" climate change: **heatwaves, drought, floods, cloudburst, storm surge**

--

- **Personal weather experiences** contain information relevant to climate attitudes and behavior
...
```
https://doi.org/10.1080/01402382.2020.1792731
]
...
- **Idea:** experimentally manipulate *and* observe heat-related __experiences__ and manipulate contextual __information__
...
- __Personal experience__ with extreme weather *can* affect perceptions, awareness, opinions towards climate change
