...
::: {.incremental}
1. Researchers and others often ask if differences in reported harassment experiences are due to heterogeneous sensitivity levels and/or norms
    - Is it? 
2. If (learning about) harassment deters citizens (especially marginal groups) from entering or engaging in politics, the implications are bad
    - Does it?
:::
...
- New survey experiment (YouGov) w/ 5,000 respondents (~3,500 so far)
- Descriptive and causal w/ preliminary results
- Preregistered
- **Treatment** = read and evaluate 5 random harassment stories 
    - random draw from 55 curated stories
...
**by individuals who are *not* easily angered by contrary viewpoints**
...
- i. Yes, *much* more (11%-points)
- ii. Yes, *much* less (8%-points)
- iii. Yes, *much* more (11%-points)
...
Harassment from **citizens/strangers** is evaluated as much more problematic...
...
- i. Yes, *much* more (9%-points)
- ii. Yes, *much* less (8%-points)
- iii. Yes, *much* more (8%-points)
...
- 5%-points increase in guessed politician % that experience harassment (63 vs. 58%)
- 5%-points increase in fear of personal exposure
...
- decrease in belief that _harassment is inevitable_
- decrease in belief that _politicians should have known_ about hard tone
- large decrease in belief that politicians talk of _harassment to get attention_ (4%-points)

## Causal

> *H2: People become politically disengaged and less likely to run for office when they hear stories about harassment against politicians*

**Future political participation (likelihood of engaging in six activities, e.g., protest, petition, SoMe post)**

- no disengagement
- instead, 3%-points  *increase* in participation
...
- large decrease in preference for political leaders that are _age 36+_ (4%-points)
- no effect on preference for _men vs. women_
...
- Important: unexpected results for **likely future candidates** &rarr; not the recruitment/composition story, we were planning
    - citizen mobilization instead?
    - (or: only good consequences of increased awareness)
- More than one paper?
