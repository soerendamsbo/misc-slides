...
8. Willingness to **run for office** in the future (*main outcome*, pretest)
...
- Instead, 1.8 %-points *increase* (e.g., **contact politician**, demonstrate, sign petition, political SoMe post)
...
- ~16 percent (1/6) categorized as 'likely candidates' with both approaches
- Analyze *conditional effects* among likely candidates
...
- Statistically significant negative **interaction** (*p* = 0.019) with conditional effects:
...
- **Citizens** are also **potential candidates** of the future 
    ...
    - potential candidates on the margin are likely **important for representation**
