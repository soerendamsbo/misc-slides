...
- Several studies exist, but they are framed in a different way:
...
--
    ...
    - still __mixed results:__ sometimes punishment, sometimes reward
...
Comprehensive __candidate survey__ w/ policy responses from __73% of *all local election candidates*__
...
- pro-climate candidates are rewarded in post-flooding elections (long after the event)

- not clear if the voters change preferences or candidates change policy
]
...
- also no DIDID for other candidate features: __incumbency__ and __pro-welfare platform__
...
- __Case:__ 2013 storm surge 'Bodil' and surrounding elections in Denmark
...
- The importance of __policy__ and the __long-lasting effects__ suggest that flood-stricken __voters' behavior is quite sophisticated__ 
