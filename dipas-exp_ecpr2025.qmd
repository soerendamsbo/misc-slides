...
subtitle: "Experimental evidence on the democratic consequences from four European democracies<br>ECPR General Conference 2025"
date: today
date-format: long
lang: en
author: 
  - Søren Damsbo-Svendsen
  - <strong>Karina Kosiara-Pedersen</strong>
...
- Instead, 1.8 %-points *increase* in **participation in six political activities** (e.g., contact politician, protest, petition, SoMe post)
...
- We find statistically significant negative **interaction** with treatment (CATEs ... &darr;):
    - 2.0 %-points RFO *decrease* for ~1/6 **highest index values**
    - 3.9 %-points RFO *decrease* for ~1/6 **highest reported pre-tests**
    - (No conditional effects for groups with __lower likelihood of running__)
- In sum, evidence that *the most likely future candidates* are in fact **scared away**
    - arguably still modest effect
...
- Citizens are also potential candidates of the future. Does it affect their **willingness to run for office?**
    ...
    - however, fairly modest (conditional) **effect size**: ~2-4 %-points
