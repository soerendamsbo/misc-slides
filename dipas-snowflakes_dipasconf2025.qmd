...
- __RQ: *How severe is harassment* against politicians to citizens, and what are theoretically and statistically significant *gaps in perceptions* of harassment?__
    - i.e., are (harassed) politicians perceived as *snowflakes* or *tough cookies*?
...
- *Why* do we find these gaps?
- How do we *explain* them? What are their *causes*? 
- How (much) do we *discuss*? 
- What are the gaps' *implications*?
- *Framing*
- Paper *structure* (four 'themes' etc.)?
- Need to throw out parts or parcel into another paper?
