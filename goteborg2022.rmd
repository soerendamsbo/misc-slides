...
- Detailed, case-level **storm surge insurance data** (Storm Council)

--

- Measured at the level of __1,386 polling districts__
...
- Ample evidence that __weather experiences can affect climate change perceptions and attitudes__

--

- But limited evidence that weather experiences affect actual __behavior__, environmental or political

--

- Several studies exist but are framed differently:

    - as __natural disasters and electoral behavior__
    
    - __retrospective voting:__ rewarding or punishing incumbents based on performance
...
- What if it's more about **policy:** 
    ...
    - voters changing preferences towards climate adaptation (and mitigation) and/or parties and candidates adopting climate policies
...
## Candidate data from 2017 local elections
...
> RQ: Are climate candidates rewarded more (punished less) by flooding in affected areas?

--

_Triple differences:_<br>
...
- not yet clear if the voters change preferences or candidates change policy 
    ...
    - (both would be interesting and could happen simultanously)
]
...
- __RQ: Do pro-climate parties and candidates benefit electorally after extreme flooding?__
...
- Detailed __data__ on flooding damages and vote shares for parties and candidates
...
- __Results:__
    ...
    - Pro-climate candidates have their election chances increased 6 pp vs. non-climate candidates

--
<br>
Still plenty of additional analysis and interpretation to do ...
